...
def main():
    ...
    parser.add_argument('-g', '--gif', dest='should_export_gif', action='store_true', help='Export GIF animation of the simulation.')
    ...
    parser.add_argument('-c', '--csv', dest='should_export_csv', action='store_true', help='Export CSV file of run statistics.')
    ...
    for run_number in range(1, args.runs + 1):
        ...
        if args.should_export_csv:
            ...
            writer.writerow([window.simulation.bicycles_through, window.simulation.pedestrians_through, window.simulation.cars_through, window.simulation.collision_counter])
